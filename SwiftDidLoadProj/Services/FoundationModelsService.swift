...
enum FoundationModelsExtractor {
    ...
    static func extract(from text: String) async -> Recipe? {
        ...
        Given a food recipe title or description, extract the main grocery ingredients needed.
        ...
        Rules:
        - Only grocery food items (not equipment like pans)
    ...
    private static func parseResponse(_ content: String) -> Recipe? {
        ...
        guard let data = jsonString.data(using: .utf8),
              ...
              !ingredientsArray.isEmpty else { return nil }
